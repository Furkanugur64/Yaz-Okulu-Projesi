<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="OgretmenGuncelle.aspx.cs" Inherits="YazOkuluProje_Katmanlı_mimari_Asp.net_.OgretmenGuncelle" %>
        ...
        <table class="nav-justified" style="width: 27%; height: 159px">
            <tr>
                <td class="modal-sm" style="width: 591px; text-align: right; height: 39px;">
                    <strong>
                        <asp:Label ID="LblID" runat="server" Text="ÖĞRETMEN ID:"></asp:Label>
                    </strong>
                </td>
            ...
            <tr>
                ...
                <td>
                    <asp:Button ID="Button1" runat="server" CssClass="btn btn-success" Height="30px" Text="Güncelle" Width="96px" OnClick="Button1_Click"   />
                </td>
            </tr>
